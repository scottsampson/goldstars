class Admin::ParticipantsController < Admin::ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @participant.save
        format.html { redirect_to(admin_participants_path, :notice => 'Participant was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @participant.update_attributes(params[:participant])
        format.html { redirect_to(admin_participants_path, :notice => 'Participant was successfully updated.') }
        format.xml  { head :ok }
      else
