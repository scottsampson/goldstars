...
listen '/srv/apps/goldstars/shared/sockets/goldstars.sock', :backlog => 2048

# Set pid location to Capistrano / Rails default
pid '/srv/apps/goldstars/shared/pids/unicorn.pid'

# Setup logging paths
stderr_path '/srv/apps/goldstars/shared/log/unicorn.error.log'
stdout_path '/srv/apps/goldstars/shared/log/unicorn.access.log'
